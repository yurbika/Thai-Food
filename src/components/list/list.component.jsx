          ...
          {item.map((food) =>
            Object.keys(food).map((key) => (
              <div key={ID_GENERATOR("food-row-")}>
                <span tabIndex={0} key={ID_GENERATOR("food-number-")}>
                  {key}.
                </span>
                <span tabIndex={0} key={ID_GENERATOR("food-name-")}>
                  {food[key]["name"]}
                </span>
                <span tabIndex={0} key={ID_GENERATOR("food-additional-info-")}>
                  {food[key]["additionalInfo"]}
                </span>
                <span tabIndex={0} key={ID_GENERATOR("food-price-")}>
